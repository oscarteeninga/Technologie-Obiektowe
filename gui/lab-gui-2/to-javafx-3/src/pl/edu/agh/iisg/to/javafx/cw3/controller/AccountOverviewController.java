...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		...
		for (Transaction trans : transactionsTable.getSelectionModel().getSelectedItems()) {
			transactions.add(trans);
		}
		RemoveTransactionCommand removeTransactionCommand = new RemoveTransactionCommand(transactions, data);
